...
document.addEventListener("contextmenu", function (_0xeb1b4f) {
    _0xeb1b4f.preventDefault();
    showProtectionMessage();
  });
  document.addEventListener("keydown", function (_0x3a4a56) {
    if (_0x3a4a56.ctrlKey && (_0x3a4a56.keyCode === 67 || _0x3a4a56.keyCode === 86 || _0x3a4a56.keyCode === 65 || _0x3a4a56.keyCode === 83 || _0x3a4a56.keyCode === 85) || _0x3a4a56.keyCode === 123) {
      _0x3a4a56.preventDefault();
      showProtectionMessage();
    }
  });
  function showProtectionMessage() {
    const _0x408850 = document.createElement("div");
    _0x408850.style.position = "fixed";
    _0x408850.style.top = "50%";
    _0x408850.style.left = "50%";
    _0x408850.style.transform = "translate(-50%, -50%)";
    _0x408850.style.backgroundColor = "rgba(0,0,0,0.8)";
    _0x408850.style.color = "white";
    _0x408850.style.padding = "20px";
    _0x408850.style.borderRadius = "10px";
    _0x408850.style.zIndex = "10000";
    _0x408850.style.textAlign = "center";
    _0x408850.style.boxShadow = "0 0 20px rgba(255,0,0,0.5)";
    _0x408850.innerHTML = "<i class=\"fas fa-lock\" style=\"font-size: 30px; margin-bottom: 10px;\"></i><br>Люблю тебя, by Shell";
    document.body.appendChild(_0x408850);
    setTimeout(() => {
      _0x408850.style.transition = "all 0.5s ease";
      _0x408850.style.opacity = "0";
      setTimeout(() => _0x408850.remove(), 500);
    }, 2000);
  }
